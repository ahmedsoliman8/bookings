...
class BookingCalendar extends Component
{
    ...
    public function getEmployeeScheduleProperty()
    {
        ...
        return $this->employee->schedules()->whereDate('date', $this->calendarSelectedDateObject)->first();
    }
    ...
    {
        $this->date = $timestamp;
        //  dd($this->availableTimeSlots->first());
    }

    public function getCalendarWeekIntervalProperty()
    {
        return CarbonInterval::days(1)->toPeriod($this->calendarStartDate, $this->calendarStartDate->clone()->addWeek());
    }
